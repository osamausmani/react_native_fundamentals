...
function App() {
    return (
        <SafeAreaView style={{ height: "100%" }}>
            ...
            <View id="MenuBar" style={{ display: 'flex', flexDirection: "row", backgroundColor: 'black', height: 60, width: "100%", alignItems: 'center', justifyContent: "space-between", paddingLeft: 20, paddingRight: 20 }}>
                <TouchableOpacity style={styles.touchButtonTransparent}  >
                    <Image style={styles.mainImage} source={require('../../assets/icon-home.png')} />

                    <Text style={styles.touchButtonText} > Home</Text>
                </TouchableOpacity>

                <TouchableOpacity style={styles.touchButtonTransparent}  >
                    <Image style={styles.mainImage} source={require('../../assets/icon-home.png')} />

                    <Text style={styles.touchButtonText} > Profile</Text>
                </TouchableOpacity>

                <TouchableOpacity style={styles.touchButtonTransparent}  >
                    <Image style={styles.mainImage} source={require('../../assets/icon-home.png')} />

                    <Text style={styles.touchButtonText} > Videos</Text>
                </TouchableOpacity>

                <TouchableOpacity style={styles.touchButtonTransparent}  >
                    <Image style={styles.mainImage} source={require('../../assets/icon-home.png')} />

                    <Text style={styles.touchButtonText} > Settings</Text>
                </TouchableOpacity>
...
const styles = StyleSheet.create({
    ...
    touchButtonText: { color: "white", fontSize: 16 },

    touchButtonTransparent: { height: 40, backgroundColor: "transparent", justifyContent: 'center', alignItems: 'center', borderRadius: 6, },
